    ...
    try:
        ...
        if request.get("method", "") == "GET":
            ...
            return {
                ...
                "body": json.dumps({
                    "status": "ok",
                    "message": "Bot webhook is running with Supabase integration",
        ...
        # Handle POST requests (Telegram updates)
            ...
            try:
                ...
                if "message" in update and "chat" in update["message"]:
                    ...
                    user_saved = save_user_to_supabase(user_data)
                    ...
                    # Special handling for /start command
                        ...
                        response_text = "👋 Welcome to the HB Telegram Bot! I'm now active and ready to help you, with Supabase integration."
                    else:
                    ...
                    if TELEGRAM_TOKEN:
                        try:
                            ...
                            # Only try to save messages if the user was saved successfully
                            if user_saved:
